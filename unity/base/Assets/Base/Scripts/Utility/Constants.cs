...
public class Constants
{
    ...
    public enum EHeader
    {
        ...
        LOAD_COMPLETED,
        TAG_CHANGE,
        ATTRIBUTE_CHANGE_VALUE,
        ATTRIBUTE_CHANGE_MAX_HEALTH,
        ATTRIBUTE_CHANGE_HEALTH,
        ATTRIBUTE_CHANGE_DAMAGE,
        ATTRIBUTE_CHANGE_SPEED,
        ATTRIBUTE_CHANGE_PICKUP_RANGE,
        ATTRIBUTE_CHANGE_PICKUP_BONUS,
        ATTRIBUTE_CHANGE_CREATE_COUNT,
        ABILITY_ACTIVATE_TAG,
    }
